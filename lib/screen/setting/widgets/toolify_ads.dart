...
class ToolifyAds extends StatefulWidget {
  final String apiUrl;
  const ToolifyAds({super.key, required this.apiUrl});

  @override
  ToolifyAdsState createState() => ToolifyAdsState();
}

class ToolifyAdsState extends State<ToolifyAds> {
